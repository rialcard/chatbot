...
//recibirÃ¡ las variables y las almacenarÃ¡ en un array.
...
//devuelve true si estÃ n todos los datos requeridos
...
function origen()
{
    ...
    if (isset($input["originalDetectIntentRequest"]["payload"]["source"])) {
        return strtoupper($input["originalDetectIntentRequest"]["payload"]["source"]); //lo transformamos todo en mayÃºscula
    } else {
...
//a esta funciÃ³n se le debe pasar un array que contenga las urls de las imÃ¡genes y la plataforma a donde debe enviarse el mensaje
...
//a esta funciÃ³n se le debe pasar un array que contenga las tarjetas, con los Ã­ndices titulo subtitulo y url, luego bajo el indice "botones" cargamos otro array con lo que debe indicar cada botÃ³n
